...
# 导入系统发育信号(lambda)数据
lamda_file <- read.csv("./data/absolute_format_core_ASV_phylogenetic_signal_protist.csv", 
                       row.names = 1) %>% 
...
# 导入随机森林生物标志物结果
rf_file <- read.csv("./data/pro_qa_log_rf_res_diff_ASV.csv", 
...
# 保存带图例版本
ggsave(final_plot,
       filename = "./result/Figure5C_protistan_core_ASVs_lambda_rf.pdf", 
