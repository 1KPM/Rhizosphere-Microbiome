...
width <- 20
height <- 18
ggsave('./FigureS17G.jpg', cross_mt2_p, width = width, height = height, dpi = 900, bg = "white", units = 'cm')
ggsave('./FigureS17G.tiff', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17G.pdf', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
...
width <- 10
height <- 10
ggsave('./FigureS17HI.jpg', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17HI.tiff', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17HI.pdf', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")

p3 <- cross_mt2_p + final_plot +plot_layout(widths = c(3,2))
width <- 30
height <- 15
ggsave('./FigureS17-Malpighiales.pdf', p3, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Malpighiales.jpg', p3, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Malpighiales.tiff', p3, width = width, height = height, units = 'cm')