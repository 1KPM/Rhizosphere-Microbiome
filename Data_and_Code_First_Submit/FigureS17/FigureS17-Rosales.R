...
width <- 20
height <- 14
ggsave('./FigureS17J.jpg', cross_mt2_p, width = width, height = height, dpi = 900, bg = "white", units = 'cm')
ggsave('./FigureS17J.tiff', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17J.pdf', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
...
width <- 10
height <- 10
ggsave('./FigureS17KL.jpg', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17KL.tiff', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17KL.pdf', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")

p2 <- cross_mt2_p + final_plot +plot_layout(widths = c(3,2))
width <- 30
height <- 15
ggsave('./FigureS17-Rosales.pdf', p2, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Rosales.jpg', p2, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Rosales.tiff', p2, width = width, height = height, units = 'cm')