...
width <- 20
height <- 14
ggsave('./FigureS17A.jpg', cross_mt2_p, width = width, height = height, dpi = 900, bg = "white", units = 'cm')
ggsave('./FigureS17A.tiff', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17A.pdf', cross_mt2_p, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
...
width <- 10
height <- 10
ggsave('./FigureS17BC.jpg', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17BC.tiff', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")
ggsave('./FigureS17BC.pdf', final_plot, width = width, height = height, units = 'cm',dpi = 900, bg = "white")


p1 <- cross_mt2_p + final_plot +plot_layout(widths = c(3,2))
width <- 30
height <- 15
ggsave('./FigureS17-Fabales.pdf', p1, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Fabales.jpg', p1, width = width, height = height, units = 'cm')
ggsave('./FigureS17-Fabales.tiff', p1, width = width, height = height, units = 'cm')