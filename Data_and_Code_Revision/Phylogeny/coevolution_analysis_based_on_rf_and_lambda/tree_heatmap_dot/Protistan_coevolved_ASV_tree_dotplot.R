...
lamda_file <- read.csv("./data/Protists_absolute_format_core_ASV_phylogenetic_signal.csv", row.names = 1) %>% 
...
#  10.04% (79/787) of protistan core ASVs
...
coevolved_pro <- read.csv('./data/TableS7C-revised-pro_ASV_qa_log_lamda_indicators.csv', row.names = 1)
coevolved_pro <- coevolved_pro[coevolved_pro$Coevolved %in% plant_colors$Order, ] 
coevolved_plot <- rf_plot[rf_plot$label %in% coevolved_pro$FeatureID, ]
...
#########################tree all core ASV
ggsave(final_plot,
       filename = "./result/Protistan_core_ASVs_lambda_rf.pdf", width = 12, height = 12, units = "cm", dpi = 900, bg = "white")
...
ggsave(final_plot2,
       filename = "./result/Protistan_core_ASVs_lambda_rf_nolegend.pdf",
       width = 8, height = 8, units = "cm", dpi = 900, bg = "white")

ggsave(final_plot2,
       filename = "./result/Protistan_core_ASVs_lambda_rf_nolegend.png",
       width = 8, height = 8, units = "cm", dpi = 900, bg = "white")
