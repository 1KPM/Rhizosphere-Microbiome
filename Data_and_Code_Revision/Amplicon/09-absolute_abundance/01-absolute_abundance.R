...
all_df <- data.frame()
for (amp in amplicon) {
    raw_df <- read.csv(paste0("../01-sort_data/06-feature_abundance/", amp, "_sample_absolute_abundance.csv"))
...
name <- paste0(dir_name, "/Sample_absolute_abundance")
...
width <- 16
height <- 12
name <- paste0(dir_name, "/absolute_abundance_barplot")
